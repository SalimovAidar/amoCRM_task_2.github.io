    ...
    <header className="header">
      <div className="header__container container">
        <div className="header__left">
          <img src={logo} alt="Логотип Welbex" className="header__logo" />
          <ul className="header__list">
            ...
            <HeaderItem
              title={'Сертификаты'}
            />
            {/* <li className="header__item header__item_1">
              <a href="#" className="header__link">
                Услуги
              </a>
            </li>
            <li className="header__item header__item_2">
              <a href="#" className="header__link">
                Виджеты
              </a>
            </li>
            <li className="header__item header__item_3">
              <a href="#" className="header__link">
                Интеграции
              </a>
            </li>
            <li className="header__item header__item_4">
              <a href="#" className="header__link">
                Кейсы
              </a>
            </li>
            <li className="header__item header__item_5">
              <a href="#" className="header__link">
                Сертификаты
              </a>
            </li> */}
        ...
        <div className="header__right">
          <a href="tel:+75555555555" className="header__phone phone">+7 555 555-55-55</a>
          <ul className="header__messengers messengers">
            <li className="messengers__item">
              <a href="#" className="messengers__link">
